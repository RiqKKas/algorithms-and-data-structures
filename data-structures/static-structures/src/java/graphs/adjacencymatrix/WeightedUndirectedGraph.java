...
public class WeightedUndirectedGraph<TYPE> {
    ...
    public WeightedUndirectedGraph(double nullLEdge, int startingCapacity) {
    ...
    public WeightedUndirectedGraph(double nullLEdge) {
        this.NULL_EDGE = nullLEdge;
    ...
    public void removeEdge(TYPE startVertex, TYPE endVertex) {
        ...
        this.adjacencyMatrix[endIndex][startIndex] = this.NULL_EDGE;
    }
    ...
    public void dijkstra(TYPE src) {
        ...
        //inicializando todas as distâncias

        ...
        for (let count = 0; count < this.size() - 1; count++) {
            ...
            for (let adjacentVertexIndex = 0; adjacentVertexIndex < this.size(); adjacentVertexIndex++) {
                /*
                    ...
                    */
                let distanceIncrement = this.adjacencyMatrix[currentElementIndex][adjacentVertexIndex] ? 1 : 0;
                let distance = shorterDistance[currentElementIndex] + distanceIncrement;

...
class Edge {
    constructor(weight, startVertex, endVertex) {
        this.weight = weight;
...
class WeightedUndirectedGraph {
    ...
    addEdge(weight, startData, endData) {
        ...
        //forma as arestas
        const newEdge1 = new Edge(weight, startVertex, endVertex);
        const newEdge2 = new Edge(weight, endVertex, startVertex);
    ...
    dijkstra(src) {
        ...
        for (let count = 0; count < this.size() - 1; count++) {
            ...
            for (let adjacentVertexIndex = 0; adjacentVertexIndex < this.size(); adjacentVertexIndex++) {
                ...
                if (edge !== null) {
                    const distance = shorterDistance[currentElementIndex] + edge.weight;
